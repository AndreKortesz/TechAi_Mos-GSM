...
2. ОБЯЗАТЕЛЬНО используй веб-поиск чтобы найти актуальные цены на оборудование
3. Рассчитай стоимость работ (примерно 30-50% от стоимости оборудования)
4. Вызови generate_kp с полными данными
...
### ВАЖНО:
- ОБЯЗАТЕЛЬНО ищи цены в интернете перед генерацией КП
- Используй реальные цены с маркетплейсов (Озон, ВБ, специализированные магазины)
- Добавляй наценку 15-25% к закупочным ценам
- Для работ используй типовые расценки: монтаж камеры ~2000-3000р, прокладка кабеля ~100-150р/м
